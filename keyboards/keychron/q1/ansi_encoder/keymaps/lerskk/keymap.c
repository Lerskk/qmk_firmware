...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ansi_82(
        ...
        _______,  KC_K   ,  KC_J   ,  KC_G   ,  KC_W   ,  KC_Z   ,  KC_B   ,  KC_H   ,  KC_COMM,  KC_DOT ,  KC_QUOT,                      KC_SCLN,  _______,
    ...
    [SIX] = LAYOUT_ansi_82(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  ARRW   ,  DARW   ,  KC_GRV ,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
