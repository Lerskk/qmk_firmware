...
#define HOME_LS LSFT_T(KC_S)
#define HOME_LC LCTL_T(KC_D)
#define HOME_RC LCTL_T(KC_N)
#define HOME_RS RSFT_T(KC_E)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ansi_82(
        ...
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        KC_TAB ,  KC_Q   ,  KC_W   ,  LT(FIVE, KC_F),  RALT_T(KC_P),  KC_B   ,             KC_J   ,  RALT_T(KC_L),  KC_U   ,  KC_Y   ,  KC_SCLN,  TO(ONE),  _______,            DF_A   ,  _______,
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        KC_BSPC,  LGUI_T(KC_A),  LALT_T(KC_R),  LSFT_T(KC_S),  LCTL_T(KC_T),  KC_G   ,     KC_M   ,  LCTL_T(KC_N),  RSFT_T(KC_E),  LALT_T(KC_I),  LGUI_T(KC_O),  KC_QUOT,                      KC_ENT ,  _______, // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        KC_ESC ,  KC_Z   ,  KC_X   ,  KC_C   ,  KC_D   ,  KC_V   ,                         KC_K   ,  KC_H   ,  TD(DANCE_03),  TD(DANCE_02),   TD(DANCE_01),                      _______,  KC_UP  ,
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  _______,  _______,                                KC_SPC,                      DF_T  ,  _______,  DF_Q   ,            KC_LEFT,  KC_DOWN,  KC_RGHT
        ),
    [ALT] = LAYOUT_ansi_82(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  _______,  _______,  _______,  _______,  _______,                         _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  KC_B   ,  KC_L   ,  LT(FIVE, KC_D),  RALT_T(KC_W),  KC_Z   ,             KC_QUOT,  RALT_T(KC_F),  KC_O   ,  KC_U   ,  KC_J   ,  TO(ONE),  _______,            DF_B   ,  _______,
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  LGUI_T(KC_N),  LALT_T(KC_R),  LSFT_T(KC_T),  LCTL_T(KC_S),  KC_G   ,     KC_Y   ,  LCTL_T(KC_H),  RSFT_T(KC_A),  LALT_T(KC_E),  LGUI_T(KC_I),  KC_QUOT,                      _______,  _______, // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  KC_Q   ,  KC_X   ,  KC_M   ,  KC_C   ,  KC_V   ,                         KC_K   ,   KC_P,  KC_DOT,  KC_COMM,  KC_SLSH,                      _______,  KC_UP  ,
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  _______,  _______,                                KC_SPC,                      _______,  _______,  DF_Q   ,            KC_LEFT,  KC_DOWN,  KC_RGHT
        ),

    [ALTTWO] = LAYOUT_ansi_82(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  _______,  _______,  _______,  _______,  _______,                         _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  KC_W   ,  KC_P   ,  LT(FIVE, KC_D),  RALT_T(KC_G),  KC_F   ,             KC_COMM,  RALT_T(KC_DOT),  KC_U   ,  KC_O   ,  KC_Y   ,  TO(ONE),  _______,            DF_B   ,  _______,
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  LGUI_T(KC_R),  LALT_T(KC_N),  LSFT_T(KC_T),  LCTL_T(KC_S),  KC_B   ,     KC_K   ,  LCTL_T(KC_H),  RSFT_T(KC_E),  LALT_T(KC_A),  LGUI_T(KC_I),  KC_QUOT,                      _______,  _______, // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  KC_X   ,  KC_V   ,  KC_M   ,  KC_C   ,  KC_Z   ,                         KC_J   ,   KC_L,  KC_QUOT,  KC_SCLN,  KC_Q   ,                      _______,  KC_UP  ,
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  _______,  _______,                                KC_SPC,                      _______,  _______,  DF_Q   ,            KC_LEFT,  KC_DOWN,  KC_RGHT
        ),
    ...
    [ONE] = LAYOUT_ansi_82(
        ...
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
        _______,  KC_QUES,  KC_PLUS,  KC_MINS,  KC_EQL ,  KC_CIRC,                         KC_QUOT,  KC_LPRN,  KC_LCBR,  KC_LBRC,  KC_PIPE,  TO(THREE),                      _______,  _______,
        // -----------------------------------------------------------------------------   ----------------------------------------------------------------------------- //
    ...
    [QWERTY] = LAYOUT_ansi_82(
        ...
        _______,  KC_A   ,  KC_S   ,  KC_D   ,  KC_F   ,  KC_G   ,  KC_H   ,  KC_J   ,  KC_K   ,  KC_L   ,  KC_SCLN,  KC_BSPC,                      KC_ENT ,  _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [ALTTWO] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
